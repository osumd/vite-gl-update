...
class ChunkMeshChunk{

    constructor()
    {

        this.lower_left = new THREE.Vector3(0,0,0);
        this.lower_right = new THREE.Vector3(1,1,1);
    ...
    generate_geometry_texture()
    {
        ...
        const fragmentShader = `
            ...
            void main() {
                ...
                vec3 chunk_x = vec3 ( chunk_upper_right.x - chunk_lower_left.x, 0.0, 0.0 );
                vec3 chunk_y = vec3 ( 0.0, chunk_upper_right.y - chunk_lower_left.y, 0.0 );
                ...
                if ( relative_primitive == 0 )
                {
                    ...
                    if ( vertex_id == 0 )
                    {
                        ...
                        vec3 position = chunk_lower_left - vec3(1,0, 0)*thickness;
                    ...
                    if ( vertex_id == 2 )
                    {
                        ...
                        vec3 position = chunk_upper_right + vec3(1,0, 0)*thickness;
                        color = vec4(position, 1);
                ...
                if ( relative_primitive == 1 )
                {
                    ...
                    if ( vertex_id == 0 )
                    {
                        ...
                        vec3 position = chunk_lower_left - vec3(1,0, 0)*thickness*2.0 + vec3(2,0,0);
                        color = vec4(position, 1);
                    ...
                    if ( vertex_id == 2 )
                    {
                        ...
                        vec3 position = chunk_upper_right + vec3(1,0, 0)*thickness*2.0 + vec3(2,0,0);
                        color = vec4(position, 1);
       ...
       // The amount of chunks to be added would be.
        ...
        for ( let i = 0; i < chunk_radius; i ++ )
        {
            ...
            for ( let j = 0; j < chunk_radius; j ++ )
            {
                    ...
                    camera_chunk_lower.x = camera_chunk_x + i*chunk_size;
                    camera_chunk_lower.y = camera_chunk_y;
                    camera_chunk_lower.z = camera_chunk_z - j*chunk_size;
